...
class TestSyncApiRequestWithRetry:
    ...
    def test_rate_limited_then_success(self):
        ...
        with patch("requests.get") as mock_get, patch("time.sleep") as mock_sleep:  # Prevent actual sleep
    ...
    def test_max_retries_exceeded(self):
        ...
        with patch("requests.get") as mock_get, patch("time.sleep") as mock_sleep:
            ...
            result = sync_api_request_with_retry("http://test.com/api", max_retries=3)
    ...
    def test_exponential_backoff_calculation(self):
        ...
        with patch("requests.get") as mock_get, patch("time.sleep") as mock_sleep:
            ...
            sync_api_request_with_retry("http://test.com/api", max_retries=4, base_delay=0.1, max_delay=10.0)
    ...
    def test_max_delay_cap(self):
        ...
        with patch("requests.get") as mock_get, patch("time.sleep") as mock_sleep:
            ...
            sync_api_request_with_retry("http://test.com/api", max_retries=10, base_delay=1.0, max_delay=5.0)
...
class TestAsyncApiRequestWithRetry:
    ...
    async def test_successful_request_first_attempt(self):
        ...
        result = await async_api_request_with_retry(mock_session, "http://test.com/api")
    ...
    async def test_max_retries_exceeded_async(self):
        ...
        with patch("asyncio.sleep") as mock_sleep:
            ...
            result = await async_api_request_with_retry(mock_session, "http://test.com/api", max_retries=3)
