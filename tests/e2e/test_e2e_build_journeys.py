...
class TestJourney1_InitialKBSetup(TestBuildKBJourneys):
...
class TestJourney2_QualityManagement(TestBuildKBJourneys):
...
class TestJourney3_ImportExport(TestBuildKBJourneys):
...
class TestJourney4_GapAnalysis(TestBuildKBJourneys):
...
class TestJourney5_ErrorRecovery(TestBuildKBJourneys):
...
class TestJourney6_PerformanceOptimization(TestBuildKBJourneys):
