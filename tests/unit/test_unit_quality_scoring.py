...
class TestQualityScoreParametrized:
    ...
    @pytest.mark.parametrize(
        ("study_type", "expected_score", "expected_explanation_text"),
        [
    ...
    @pytest.mark.parametrize(
        ("sample_size", "expected_bonus", "expected_in_explanation"),
        [
    ...
    @pytest.mark.parametrize(
        ("paper_data", "expected_score_range", "required_explanation_terms"),
        [
            # Combined scoring tests
            (
                {"study_type": "systematic_review", "year": 2024, "sample_size": 1000, "has_full_text": True},
                (100, 100),
                ["systematic review", "recent", "large sample", "full text"],
            ),
            ({"study_type": "case_report", "year": 2015, "has_full_text": False}, (50, 50), ["case report"]),
            (
                {"study_type": "rct", "year": 2023, "sample_size": 500, "has_full_text": True},
                (94, 96),
                ["rct", "recent", "substantial sample", "full text"],
            ),
            # Missing fields
            ({}, (50, 50), ["unknown"]),
            # Only some fields
    ...
    def test_quality_score_calculation_should_stay_within_bounds(self):
        ...
        min_paper = {"study_type": "case_report", "year": 1990, "has_full_text": False}
