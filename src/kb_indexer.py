...
class KBIndexer:
    ...
    def embedding_model(self) -> Any:
        ...
        if self._embedding_model is None:
            ...
            try:
                ...
                EMBEDDING_MODEL = "sentence-transformers/multi-qa-mpnet-base-dot-v1"  # type: ignore[no-redef] # noqa: N806
            ...
            self._embedding_model = SentenceTransformer(EMBEDDING_MODEL, device=self.device)  # type: ignore[assignment]
            self.model_version = "Multi-QA MPNet"  # type: ignore[assignment]
        ...
        try:
            ...
            if hasattr(self, "device") and self.device == "cuda":
                try:
                    ...
                    # GPU detection failed, fall back to CPU - no logging needed
                    # as we report the device being used later
                    pass
    ...
    def load_embedding_cache(self) -> dict[str, Any]:
        ...
        if self.embedding_cache is not None:
            return self.embedding_cache  # type: ignore[return-value]

        # Use config constants for cache file names
        try:
            from src.config import EMBEDDING_CACHE_FILE
        except ImportError:
            EMBEDDING_CACHE_FILE = Path(".embedding_cache.json")  # type: ignore[no-redef] # noqa: N806
        ...
        self.embedding_cache = {"embeddings": None, "hashes": []}  # type: ignore[assignment]
        return self.embedding_cache  # type: ignore[return-value]
    ...
    def create_index(self, papers: list[dict[str, Any]]) -> Any:
        ...
        if not texts:
            ...
            try:
                ...
                EMBEDDING_DIMENSIONS = 768  # type: ignore[no-redef] # noqa: N806
