...
"""
        ...
        await loop.run_in_executor(None, self._write_report_sync, output_path, report_content)
    ...
    def _write_report_sync(self, output_path: str, content: str) -> None:
        """Synchronous helper for writing report to file."""
